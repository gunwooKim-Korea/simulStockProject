...
public class companyInfoDTO {
	...
	public String toString() {
		return "companyInfoDTO [crp_nm=" + crp_nm + ", crp_nm_e=" + crp_nm_e
				+ ", crp_nm_i=" + crp_nm_i + ", stock_cd=" + stock_cd
				+ ", ceo_nm=" + ceo_nm + ", crp_cls=" + crp_cls + ", crp_no="
				+ crp_no + ", bsn_no=" + bsn_no + ", adr=" + adr + ", hm_url="
				+ hm_url + ", ir_url=" + ir_url + ", phn_no=" + phn_no
				+ ", fax_no=" + fax_no + ", ind_cd=" + ind_cd + ", est_dt="
				+ est_dt + ", acc_mt=" + acc_mt + "]";
	}
	...
	public companyInfoDTO(String crp_nm, String crp_nm_e, String crp_nm_i,
			String stock_cd, String ceo_nm, String crp_cls, String crp_no,
			String bsn_no, String adr, String hm_url, String ir_url,
			String phn_no, String fax_no, String ind_cd, String est_dt,
			String acc_mt) {
		super();
		this.crp_nm = crp_nm;
		this.crp_nm_e = crp_nm_e;
